...
import { createEvent, getMyEvents, getEventByCode, verifyEventPassword, getEventQRCode, updateEvent, requestEventOtp, verifyEventOtp, deleteEvent, updatePortfolioStatus, reprocessEventMedia } from '../controllers/eventController';
...
router.post('/:eventId/reprocess', authenticateJWT, requireRoles(['STUDIO_OWNER', 'TEAM_MEMBER']), reprocessEventMedia);
